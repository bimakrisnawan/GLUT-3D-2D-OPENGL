...
void matahari() {
	glPushMatrix();
	glColor4f(0.937, 0.639, 0.043, 0.8);
	glTranslatef(0, 2000, 900);
	glutSolidSphere(100.0, 30, 30);
	glEnd();
	glPopMatrix();

	glPushMatrix();
	glColor4f(0.937, 0.639, 0.043, 0.01);
	glTranslatef(0, 2000, 900);
	int r = 400;
	for (int i = 0; i < 100; i++) {
		glutSolidSphere(100 + r, 30, 30);
		r = r + 1;
	}
	glEnd();
	glPopMatrix();
...
void draw() {
	...
	//untuk taneman udah aku bikin fungsi void tanaman();
	//kalo mau pakek ya monggo, kalo mau buat baru ya monggo juga :)
